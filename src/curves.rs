...
fn create_jacobi() -> HashMap<String,ECCCurve> {
	...
	retv.insert(SECT571k1_NAME.to_string(),ECCCurve::new(SECT571k1_NAME,&japt));
	...
	retv.insert(SECT571r1_NAME.to_string(),ECCCurve::new(SECT571r1_NAME,&japt));
...
fn create_curve_name() -> HashMap<String,String> {
	...
	retv.insert(SECT571k1_OID.to_string(),SECT571k1_NAME.to_string());
	retv.insert(SECT571r1_OID.to_string(),SECT571r1_NAME.to_string());
